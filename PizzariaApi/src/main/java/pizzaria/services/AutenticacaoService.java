...
public class AutenticacaoService {
	 @Autowired
		...
		@Value("${pizzaria.jwt.expiration}")
		private String expiration;

		@Value("${pizzaria.jwt.secret}")
		private String secret;

		@Value("${pizzaria.jwt.issuer}")
		private String issuer;

		public String autenticar(AutenticacaoForm authForm) throws AuthenticationException {

			Authentication authenticate = authManager.authenticate(new UsernamePasswordAuthenticationToken(authForm.getUsername(), authForm.getSenha()));
